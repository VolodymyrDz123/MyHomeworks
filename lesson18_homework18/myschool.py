...
class School:
    ...
    def get_school_fees(self, expected_profit: int):
        # try:
...
class SchoolClass:
    ...
    def add_learner(self, learner: Learner):
        if learner in self.learners:
            return f"{learner.name} already in the class"
...
if __name__ == "__main__":
    ...
    learner_1 = Learner("lerner_1", "lastname", datetime.date(2000, 2, 20), school_1)
    learner_2 = Learner("lerner_2", "lastname", datetime.date(2000, 2, 20), school_1)
    learner_3 = Learner("lerner_3", "lastname", datetime.date(2000, 2, 20), school_1)
    ...
    school_class_2.add_learner(learner_3)
    print(teacher_1.mark(12, learner_1))
    print(teacher_1.mark(12, learner_1))
    print(teacher_1.mark(8, learner_2))
    print(teacher_2.mark(6, learner_3))
    print(teacher_2.mark(2, learner_3))
    print(learner_1.get_average_mark())
    print(learner_2.get_average_mark())
    print(learner_3.get_average_mark())
    print(school_class_1.get_class_marks())
    print(school_1.get_school_marks())
    print(school_1.learners)
    print(school_class_1.add_learner(learner_2))
    print(school_1.learners)
